    ...
    return (
        <section className="py-16 px-4">
            <div className="container mx-auto">
                <h2 className="text-center text-gray-600 text-3xl md:text-4xl font-medium mb-12">Lo que han dicho nuestros invitados</h2>
                        ...
                        >
                            {testimonials.map((testimonial, index) => (
                                <div key={index} className="w-1/2 flex-shrink-0 px-4">
                                    <div className="bg-[#FF9A8B] rounded-xl text-[#4A4A4A] p-8 h-full">
                        ...
                        {Array.from({ length: getNumberOfDots() }).map((_, index) => (
                            <button
                                ...
                                className={cn(
                                    ...
                                    currentSlide === index ? "bg-[#FF9B9B]" : "bg-gray-300",
                                )}
